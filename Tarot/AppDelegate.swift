...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let masterViewController = navControllerForMasterView.topViewController as! TarotCardTableViewController
        ...
        let defaultCard = Model.sharedInstance.deckOfCards.naturalOrder()[0]
        ...
        detailViewController.currentCard = defaultCard
